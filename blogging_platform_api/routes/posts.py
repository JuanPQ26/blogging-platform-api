...
def get_posts(
    ...
    return {"msg": "Posts found", "data": posts}
...
def get_post(
    ...
    return {"msg": "Post found", "data": post_found}
...
def create_post(
    ...
    return {"msg": "Post created successfully", "data": post_created}
...
def update_post(
    ...
    return {"msg": "Post updated successfully", "data": post_updated}
...
def delete_post(
    ...
    return {"msg": "Post deleted successfully", "data": None}
